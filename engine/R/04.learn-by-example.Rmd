...
<div class='row'>
<div class='col-md-9'>
<p class='leadtop'> This section is basically a verbose version of selected topics from <code4>example(data.table)</code4> to illustrate the most common data manipulation operations using `data.table`. </p>
...
<p > This is already mentioned in the [Quick introduction guide](). But for completeness, we'll cover it again. </p>
