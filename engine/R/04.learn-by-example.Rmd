...
<p > <code4>i</code4> can be `integer`, `logical`, `character` vector, `expression` (usually of column names), a `list` or a `data.table`. We'll consider each one of these cases with examples. </p>
<ul class='nav nav-tabs' style='margin-bottom:15px'>
