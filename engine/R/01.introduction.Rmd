...
<div class='row'>
<div class='col-md-9'>
<p class='leadtop'> This section provides general information about the `data.table` project. </p>
...
<p > If you're unsure as to whether it's a<span class='text-danger'> **bug**</span> or not, then it might be better to verify it by posting it as a question either on stackoverflow or on the data.table mailing list. Check the <a href="#get-help">Getting help</a> section for more info on posting questions. </p>
